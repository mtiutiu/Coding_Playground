...
class Characteristic:
    ...
    # getting this kind of exception for this method about arguments mismatch(that's why the a,b,c)
    # Traceback (most recent call last):
    #   File "/usr/lib/python3/dist-packages/gi/overrides/Gio.py", line 143, in __async_result_handler
    #     result_callback(obj, self._unpack_result(ret), real_user_data)
    # TypeError: _enable_notifications_succeeded() takes 1 positional argument but 4 were given
    def _enable_notifications_succeeded(self, a, b, c):
        """
    ...
    def _enable_notifications_failed(self, gerror):
        """
