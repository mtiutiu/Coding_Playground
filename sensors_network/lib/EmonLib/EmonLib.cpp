...
//--------------------------------------------------------------------------------------
void EnergyMonitor::voltageTX(float _VCAL, float _PHASECAL)
{
   inPinV = 2;
   VCAL = _VCAL;
   PHASECAL = _PHASECAL;
...
void EnergyMonitor::currentTX(unsigned int _channel, float _ICAL)
{
...
//--------------------------------------------------------------------------------------
float EnergyMonitor::calcIrms(unsigned int Number_of_Samples)
{
