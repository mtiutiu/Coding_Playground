...
#define DEFAULT_LED_BLINK_PERIOD 100
// The RX LED default pin
#define DEFAULT_RX_LED_PIN A0
// The TX LED default pin
#define DEFAULT_TX_LED_PIN A1
// The Error LED default pin
#define DEFAULT_ERR_LED_PIN A2
...
#define MY_ATSHA204_PIN A3 // A3 - pin where ATSHA204 is attached

// MySigningAtsha204Soft default settings
#define MY_RANDOMSEED_PIN A7 // A7 - Pin used for random generation (do not connect anything to this)
